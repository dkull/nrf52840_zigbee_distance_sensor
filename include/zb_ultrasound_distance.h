...
#define ZB_ZCL_DECLARE_HA_ULTRASOUND_DISTANCE_SIMPLE_DESC(ep_name, ep_id, in_clust_num, out_clust_num) \
...
#define ZB_ULTRASOUND_DISTANCE_IN_CLUSTER_NUM 6
#define ZB_ULTRASOUND_DISTANCE_OUT_CLUSTER_NUM 0
#define ZB_ULTRASOUND_DISTANCE_REPORT_ATTR_COUNT \
...
#define ZB_DECLARE_ULTRASOUND_DISTANCE_EP(ep_name, ep_id, cluster_list) \
	ZB_ZCL_DECLARE_HA_ULTRASOUND_DISTANCE_SIMPLE_DESC(ep_name, ep_id, \
		ZB_ULTRASOUND_DISTANCE_IN_CLUSTER_NUM, ZB_ULTRASOUND_DISTANCE_OUT_CLUSTER_NUM); \
